...
str2 = 37;
     ...
     var labels = ["0", "28", "9", "26", "30", "11",
       "7", "20", "32", "17", "5", "22", "34", "15",
       "3", "24", "36", "13", "1", "00", "27", "10", "25", "29",
...
loopevent();
  ...
  function RouletteSpreadCreator(i){
    ...
    } else if (worksheetData[i][BetPosition].formattedValue == "STRAIGHT_UP_00") {
      data[19] += 1;
      beteuro = worksheetData[i][currency].value;
      RouletteLayout(60, 110,beteuro)
  ...
  function Winner(i){
     beteuro = worksheetData[i][currency].value;
      ...
      } else if (worksheetData[i][3].formattedValue == "00") {  
        Chip(757, 110,beteuro)
      }
